    ...
    <>
      <section className="hero-grid">
        <div className="hero-card fade-in">
          ...
          <h2 className="hero-title">
            A quiet archive for code, failures, and repeatable fixes.
          </h2>
          <p className="hero-meta">
            코프링 (kopring) 실험, 프론트엔드 구조화, 인프라 회고를 섹션별로
            정리하는 정적 블로그예요. 짧은 메모는 `tweet`, 긴 정리는 `diary`,
            판단과 회고는 `review`에 쌓아요.
          </p>
      ...
      <section className="section-grid">
        <div className="section-panel fade-in delay-1">
          ...
          <p>
            구조를 길게 설명하고, 다시 참고할 수 있게 실험과 결정 배경을 함께
            남겨요.
          </p>
        ...
        <div className="section-panel fade-in delay-1">
          ...
          <p>
            짧은 링크 메모, 작게 배운 점, 빠르게 공유할 만한 포인트를 모아둬요.
          </p>
        ...
        <div className="section-panel fade-in delay-2">
          ...
          <p>
            무엇을 선택했고 왜 바꿨는지, 결과와 트레이드오프까지 정리하는
            공간이에요.
          </p>
